...
cyberrhodzURL is an open-source URL masking and analysis tool designed for **security research, phishing awareness, and defensive testing**.  
...
>
> cyberrhodzURL is a proof-of-concept project intended for **security research, phishing awareness training, and authorized penetration testing**.
...
```
```
python3 cyberrhodzURL.py
```

#### How To Run On CLI:
```
cyberrhodzURL <your-phishing-link> <any-custom-domain> <any-phishing-keyword>
```
```
Example: cyberrhodzURL https://ngrok.com gmail.com accout-login
```
### Python code:
```py
import subprocess
...
command = ["python3", "-m", "cyberrhodzURL.main", "https://ngrok.com", "facebook.com", "login"]
